...
<head>
    ...
    <!-- Optional: lightbox for galleries -->
...
<body>
    <!-- Topbar -->
    <div class="topbar py-1 shadow-sm">
        <div class="container d-flex justify-content-between align-items-center small">
            <div>
                <i class="fas fa-phone-alt me-1"></i> +8801625738164
                <span class="mx-2">|</span>
                <i class="far fa-envelope me-1"></i> agroconnect@gmail.com
            </div>
            <div>
                <a href="#" class="me-2 text-decoration-none text-muted"><i class="fab fa-facebook"></i></a>
                <a href="#" class="me-2 text-decoration-none text-muted"><i class="fab fa-youtube"></i></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white sticky-top shadow-sm">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="{{ route('home') }}">
                <img src="{{ asset('final_eagri/img/agri.png') }}" alt="AgroConnect logo">
                <span class="fw-bold text-success">AgroConnect</span>
            </a>
            ...
            <div class="d-flex align-items-center">
                @if (Session::get('c_username'))
                    <a href="{{ route('wishlist', ['c_username' => Session::get('c_username')]) }}"
                        class="btn btn-outline-success me-2" title="Wishlist"><i class="far fa-heart"></i></a>
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow">
                            ...
                            <li><a class="dropdown-item" href="{{ route('cust_order_messages') }}"><i
                                        class="fas fa-box me-2"></i> Orders</a></li>
    ...
    <!-- Secondary Navbar (categories, responsive) -->
...
<footer id="site-footer" class="pt-5" role="contentinfo" aria-label="Site Footer">
  <div class="container">
    <div class="row g-4 align-items-start">
      ...
      <div class="col-md-4">
        <a href="{{ route('home') }}" class="d-inline-flex align-items-center mb-3 text-decoration-none">
          <img src="{{ asset('final_eagri/img/agri.png') }}" alt="AgroConnect" style="height:44px;width:auto;margin-right:10px;">
          <span class="h5 mb-0 fw-bold text-success">AgroConnect</span>
        </a>
        <p class="text-muted small mb-2">Empowering sustainable agriculture through direct connections between farmers and buyers. Fair pricing • Secure bidding • Verified partners.</p>

        <div class="d-flex gap-2 mt-3">
          <a class="btn btn-outline-light btn-sm" href="#" aria-label="Facebook"><i class="fab fa-facebook-f"></i></a>
          <a class="btn btn-outline-light btn-sm" href="#" aria-label="YouTube"><i class="fab fa-youtube"></i></a>
          <a class="btn btn-outline-light btn-sm" href="#" aria-label="Instagram"><i class="fab fa-instagram"></i></a>
        </div>
      ...
      <div class="col-md-3">
        ...
        <p class="small text-muted">Get monthly updates, crop tips and market alerts. No spam — unsubscribe any time.</p>

        <form id="footer-subscribe" class="d-flex gap-2" aria-label="Subscribe to newsletter">
          @csrf
          <input id="footer-subscribe-email" type="email" name="email" class="form-control form-control-sm" placeholder="you@example.com" aria-label="Your email" required>
          <button id="footer-subscribe-button" class="btn btn-success btn-sm" type="submit">Subscribe</button>
        </form>

        <div id="footer-subscribe-msg" class="small mt-2" aria-live="polite" style="min-height:1.2rem;"></div>
      </div>
    </div>
    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-center gap-2">
      <div class="small text-muted">© {{ now()->year }} AgroConnect 🌾 — Built for farmers and buyers.</div>
      <div class="small text-muted">Terms • Privacy • <a href="{{ route('contact') }}" class="text-decoration-none">Support</a></div>
    </div>
  </div>
</footer>

    <!-- WhatsApp floating (kept single copy, improved accessibility) -->
    <div id="whatsapp-chat-container" aria-live="polite">
        ...
        <div id="whatsapp-popup" class="card shadow-lg p-0"
            style="display:none; width:320px; position:fixed; right:20px; bottom:90px; z-index:1201;">
            <div class="card-header bg-success text-white d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center gap-2">
                    <img src="https://via.placeholder.com/36?text=A" alt="AgroConnect" class="rounded-circle"
                        width="36" height="36">
                    <div>
                        <div class="fw-semibold">AgroConnect</div>
                        <div class="small">Usually replies within a few hours</div>
                    </div>
                </div>
                <button class="btn-close btn-close-white" id="close-popup" aria-label="Close chat"></button>
            </div>
            <div class="card-body">
                <p class="small text-muted mb-2">Type message and press Send — opens WhatsApp in a new tab.</p>
                <textarea id="whatsapp-message" class="form-control mb-2" rows="3" placeholder="Hello AgroConnect,..."></textarea>
                <button id="send-whatsapp" class="btn btn-success w-100" type="button"><i
                        class="fab fa-whatsapp me-2"></i>Send</button>
            </div>
        </div>
    </div>
    ...
    <style>
      ...
      @media (max-width: 768px){
        .crop-card img{ height: 140px; }
      }
    
      /* ---------- Search suggestions (positioned below input) ---------- */
      #main-search{ overflow: visible !important; /* ensure dropdown is visible */ }
      #search-suggestions{
        position: absolute;
        top: 100%;           /* place directly under the input container */
        left: 0;
        width: 100%;
        background: #fff;
      ...
      #search-suggestions a:hover, #search-suggestions div:hover{
        background: #f6f9f6;
      }
      ...
      /* ---------- Footer (upgraded agro-themed) ---------- */
      #site-footer{
        /* light, warm agro gradient (not solid black) */
      ...
      #site-footer a:hover{ color: var(--agro-green); text-decoration: underline; }
    
      #site-footer .text-success{ color: var(--agro-green) !important; }
      ...
      /* subtle spacing / small variations */
      #site-footer .small.text-muted{ color: #55606a; }
      ...
      /* keep footer widgets light — no heavy backgrounds here */
      #site-footer .col-md-4, #site-footer .col-md-3, #site-footer .col-md-2{
