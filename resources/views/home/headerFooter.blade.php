            ...
            @if(Session::get('c_username'))
                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li><a class="dropdown-item" href="{{ route('cust_profile',['c_username'=>Session::get('c_username')]) }}">
                            <i class="fa fa-user"></i> Profile</a></li>
                        <li><a class="dropdown-item" href="{{ route('c_message') }}"><i class="fas fa-comment"></i> Confirm Buy</a></li>
                        <li><a class="dropdown-item" href="{{ route('cust_order_messages') }}"><i class="fas fa-box"></i> Orders</a></li>
                        <li><a class="dropdown-item" href="{{ route('c_settings') }}"><i class="fas fa-user-cog"></i> Settings</a></li>
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
            <ul class="navbar-nav mx-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Summer Products</a>
                    <ul class="dropdown-menu">
                        @foreach(App\Models\categories_info::where('categories_status',1)->get() as $categorie)
                            <li><a class="dropdown-item" href="{{ route('Session_Categories',['crop_type'=>$categorie->id,'crop_session'=>1]) }}">
                                {{ $categorie->categories_name }}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Winter Products</a>
                    <ul class="dropdown-menu">
                        @foreach(App\Models\categories_info::where('categories_status',1)->get() as $categorie)
                            <li><a class="dropdown-item" href="{{ route('Session_Categories',['crop_type'=>$categorie->id,'crop_session'=>2]) }}">
                                {{ $categorie->categories_name }}</a></li>
                        @endforeach
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Monsoon Products</a>
                    <ul class="dropdown-menu">
                        @foreach(App\Models\categories_info::where('categories_status',1)->get() as $categorie)
                            <li><a class="dropdown-item" href="{{ route('Session_Categories',['crop_type'=>$categorie->id,'crop_session'=>3]) }}">
                                {{ $categorie->categories_name }}</a></li>
                        @endforeach
                    </ul>
                </li>
