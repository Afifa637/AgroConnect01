            ...
            <div class="col-lg-3 col-md-6 mb-4">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-footer text-center bg-white">
                        ...
                        <a class="btn btn-outline-warning btn-sm" href="{{ route('crop_unpublished_save',['id'=>$crop->id]) }}"
                           onclick="return confirm('Are you sure you want to unpublish this crop?');" title="Unpublish">
