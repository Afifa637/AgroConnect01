...
<div class="container-fluid py-4">
  <h3 class="text-agro text-center mb-4"><i class="fa-solid fa-box-open"></i> Unpublished Crops</h3>
    ...
    <div class="col-lg-3 col-md-6 mb-4">
      <div class="card h-100 shadow-sm">
        ...
        <div class="card-footer text-center bg-white">
          <a class="btn btn-agro btn-sm" href="{{ route('crop_details',['id'=>$crop->id]) }}" target="_blank">
            <i class="fa-solid fa-circle-info"></i>
          </a>
          <a class="btn btn-outline-success btn-sm"
             href="{{ route('crop_published_save',['id'=>$crop->id]) }}"
             onclick="return confirm('Publish this crop?');">
